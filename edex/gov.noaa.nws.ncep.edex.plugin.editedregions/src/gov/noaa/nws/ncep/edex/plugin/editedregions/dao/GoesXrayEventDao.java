...
public class GoesXrayEventDao extends DefaultPluginDao {
    ...
    // * @throws SQLException
    // */
    // public Vector<Integer> getRawEventIds(final long beginDTTM, final long
    // endDTTM) throws SQLException {
    //
    ...
    //
    // logger.info(" Inside GoesXrayEventDao.getRawEventIds(), executing sql
    // query = "
    ...
    // * @throws SQLException
    // */
    // public List<Map<String, Object>> getRawEvents(final long beginDTTM, final
    // long endDTTM) throws SQLException {
    //
    // Calendar begin = Calendar.getInstance();
    // Calendar end = Calendar.getInstance();
    // begin.clear();
    ...
    // = "
    // + ps.toString() + " - " + " - " + SqlQueries.GET_GOES_XRAY_EVENTS + "
    // with Parameters 1-2 as: " +
    // beginDTTM + "," +
    // endDTTM);
    //
    // rs = ps.executeQuery();
    ...
    // // do a workaround where we replace the word IDLIST with the generated
    // CSV
    // // list of id's
    // String sqlQuerry =
    // SqlQueries.SET_GOES_EVENTS_TO_PROCESSED.replace("IDLIST", recordIdsCSV);
    //
    // try {
    ...
    //
    // logger.info(" EDITEDEVENTS.GoesXrayEventDao.setEventsToProcessed,
    // numRecordsUpdated = " + numRecordsUpdated);
    // } catch (SQLException e) {
