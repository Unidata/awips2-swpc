...
public class ProcessRegionsCommand extends BaseCommand {
	 ...
	 * Logger
	 */
	 private static final IUFStatusHandler statusHandler = UFStatus.getHandler(ProcessRegionsCommand.class);
		...
		try {		
			...
			if (tmp != null) {
				...
				event.setBeginTime(Integer.valueOf((beginDTTM
						.get(Calendar.HOUR_OF_DAY) + "" + ERCommandUtil.getTwoDigitValueAsString(beginDTTM
						.get(Calendar.MINUTE)))));
			} else {
