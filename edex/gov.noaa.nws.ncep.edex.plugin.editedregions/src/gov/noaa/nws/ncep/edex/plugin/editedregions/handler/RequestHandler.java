...
import gov.noaa.nws.ncep.common.dataplugin.editedregions.response.SaveResponse;
...
import gov.noaa.nws.ncep.edex.plugin.editedregions.commands.SaveCommand;
...
//	            // the request had parameters necessary to satisfy
//	            // the command
//	            GetAssignedRegionReportsCommand getAssignedRegionReportsCommand = new GetAssignedRegionReportsCommand();
...
//	            addEventResponse = (AddEventResponse) getAssignedRegionReportsCommand.execute();
//            
//            }
//            
