package gov.noaa.nws.ncep.edex.plugin.editedevents.sql;
...
public abstract class SqlQueries {
	...
	public static final String REMOVE_DELETED_EVENTS = 
			"DELETE FROM swpc_event WHERE begindate >= ? AND statuscd = '" + (EditedEventsConstants.EVENT_STATUS.DELETED.ordinal() + 1) + "' AND statustext = '" + EditedEventsConstants.EVENT_STATUS.DELETED.toString() + "'";
	...
	public static final String SET_EVENTS_AGE_TO_OLD = 
			"UPDATE swpc_event SET age = '"  + EditedEventsConstants.EVENT_AGE.OLD.toString() + "', changeflag=0 WHERE begindate >= ? AND age = '" + EditedEventsConstants.EVENT_AGE.NEW.toString() + "' OR age = '" + EditedEventsConstants.EVENT_AGE.COR.toString() + "'";
