...
import gov.noaa.nws.ncep.common.dataplugin.editedregions.request.AddNewBinForEventRequest;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.request.intf.IRequest;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.response.intf.IResponse;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.results.AddNewBinForEventResults;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.results.intf.IResults;

/**
 * The response class holding the results obtained
 * from the execution of the AddNewBinForEventCommand 
 * 
 * <pre>
 *
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class AddNewBinForEventResponse extends BaseResponse<AddNewBinForEventResponse> implements
IResponse {
	...
	/**
	 * The results from the AddNewBinForEventCommand
	 */
	@DynamicSerializeElement
	private AddNewBinForEventResults results = null;
	 ...
	 * 
	 */
    public AddNewBinForEventResponse() {
    ...
    public void setResults(IResults results) {
        this.results = (AddNewBinForEventResults) results;
    }
