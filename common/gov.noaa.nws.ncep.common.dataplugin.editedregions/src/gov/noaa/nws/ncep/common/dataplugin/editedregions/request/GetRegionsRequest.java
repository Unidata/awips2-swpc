 ...
 * obtain the regions that can be assigned to a region report
 * 
 * @author jtravis
 * @version 1.0
 */
@DynamicSerialize
public class GetRegionsRequest extends
        Request<GetRegionsRequest> implements IRequest {
	...
	/**
	 * Constructor supplying time parameters to use
	 * as filter for obtaining regions based on a time range
	 * 
	...
	/**
	 * Note setting the begin time parameter is only to be
	 * performed via the constructor.  This method is required
	...
	/**
	 * Note setting the end time parameter is only to be
	 * performed via the constructor.  This method is required
	 * for serialization purposes only.
	 * 
	...
	/**
	 * Note that this method is required for serialization purposes
	 * but setting the filterApplied parameter on the request should only
	 * be performed by the constructor.  Thus, this method does not alter
	 * the filterApplied parameter.
	 * 
