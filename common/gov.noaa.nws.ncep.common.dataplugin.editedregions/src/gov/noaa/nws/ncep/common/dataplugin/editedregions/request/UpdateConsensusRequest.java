 ...
 */
@DynamicSerialize
public class UpdateConsensusRequest extends Request<UpdateConsensusRequest>
        implements IRequest {
    ...
    /**
     * The updated region consensus object.
     */
    @DynamicSerializeElement
    private RegionConsensus consensus;

    /**
     * 
     */
    public UpdateConsensusRequest() {
     ...
     */
    public RegionConsensus getConsensus() {
        return consensus;
    }

    /**
     * @param consensus
     *            the consensus to set
     */
    public void setConsensus(RegionConsensus consensus) {
