...
/**
 * The response returned to the caller if the request made was not recognized.
 * 
 *
 * <pre>
 * 
 ...
 */
@DynamicSerialize
public class UnknownRequestResponse extends BaseResponse<UnknownRequestResponse>
     ...
     * (non-Javadoc)
     * 
     * @see gov.noaa.nws.ncep.common.dataplugin.editedevents.response.iR9583ntf.
     * IResponse#hasErrors()
     */
    @Override
    ...
    public IResults getResults() {
        return null; // just return null as there are no results for this
                     // response type
    }
