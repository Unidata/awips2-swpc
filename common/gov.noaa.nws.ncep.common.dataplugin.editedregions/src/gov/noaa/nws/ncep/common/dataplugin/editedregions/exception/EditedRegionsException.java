 ...
 * can can be thrown during execution of Edited Regions functionality
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class EditedRegionsException extends Exception {
	...
	/**
	 * Create an EditedRegionsException using the message
	 * passed
	 * 
	 * @param message
	 */
	...
	/**
	 * Create an EditedRegionsException using the cause
	 * passed
	 * 
	 * @param cause
	 */
	...
	/**
	 * Create an EditedRegionsException using the
