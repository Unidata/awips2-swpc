...
import gov.noaa.nws.ncep.common.dataplugin.editedregions.request.GetEventTypesRequest;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.request.intf.IRequest;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.response.intf.IResponse;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.results.GetEventTypesResults;
import gov.noaa.nws.ncep.common.dataplugin.editedregions.results.intf.IResults;

/**
 * The response class holding the results obtained
 * from the execution of the GetEventTypesCommand
 * <pre>
 * 
 * SOFTWARE HISTORY
 * 
 ...
 */
@DynamicSerialize
public class GetEventTypesResponse extends BaseResponse<GetEventTypesResponse> implements IResponse {
     ...
     */
    @DynamicSerializeElement
    private GetEventTypesResults results = null; 
	...
	public void setResults(IResults results) {
		this.results = (GetEventTypesResults) results;
	}
