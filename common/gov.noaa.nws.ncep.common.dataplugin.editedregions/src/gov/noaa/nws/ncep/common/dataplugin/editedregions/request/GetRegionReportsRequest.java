 ...
 */
@DynamicSerialize
public class GetRegionReportsRequest extends
        Request<GetRegionReportsRequest> implements IRequest {
    ...
    /**
     * Indicates reports that are not assigned
     * to a region should be obtained
     */
    @DynamicSerializeElement
    private boolean obtainUnassignedReports = true;
    
    /**
     * Indicates reports that are assigned to a
     * region should be obtained
     */
    @DynamicSerializeElement
	...
	/**
	 * @param obtainUnassignedReports the obtainUnassignedReports to set
	 */
	...
	/**
	 * @param obtainAssignedReports the obtainAssignedReports to set
	 */
