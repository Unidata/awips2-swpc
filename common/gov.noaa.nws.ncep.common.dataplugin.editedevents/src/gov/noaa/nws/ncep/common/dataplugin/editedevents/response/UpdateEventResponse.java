...
/**
 * The class used to represent the response from execution of the UpdateEventCommand
 *
 *  <pre>
 * 
 * SOFTWARE HISTORY
 ...
 */
@DynamicSerialize
public class UpdateEventResponse extends BaseResponse<UpdateEventResponse>
