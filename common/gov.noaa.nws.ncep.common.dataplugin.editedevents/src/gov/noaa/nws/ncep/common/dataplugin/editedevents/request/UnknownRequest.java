...
/**
 * Request class used if the request supplied to the gateway
 * is null or the request is of a type that the RequestHandler
 * does not recognize.
 * 
 * 
 * <pre>
 ...
 * @version 1.0
 */
public class UnknownRequest extends Request<ProcessEventsRequest> implements IRequest {
